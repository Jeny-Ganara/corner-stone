...
$evision_corporate_sections['evision-corporate-testimonial'] =
    array(
        ...
        'description'    => sprintf( __( 'Please select page for testimonial section. Page title will be  name/position of the sayer and page featured image will be sayer image. You can manage page from %1$s here %2$s. Please use appropriate image size( about 175*175 ) and select pages that have same size of images', 'evision-corporate' ), '<a href="'.esc_url( admin_url( 'edit.php?post_type=page' ) ).'" target="_self">','</a>' ),
