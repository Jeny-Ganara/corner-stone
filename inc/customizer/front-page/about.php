...
$evision_corporate_sections['evision-corporate-about'] =
    array(
        ...
        'description'    => sprintf( __( 'Please select page for about section. Page title will be about title and page content will be about content. You can manage page from %1$s here %2$s. Also you will be able to select font awesome icon as about icon', 'evision-corporate' ), '<a href="'.esc_url( admin_url( 'edit.php?post_type=page' ) ).'" target="_self">','</a>' ),
    ...
    array(
        ...
        'evision-corporate-about-icon' => array(
            'control' => array(
                ...
                'type'                  => 'text',
                'priority'              => 20,
                'description'           => sprintf( __( 'Use font awesome icon: Eg: %1$s. %2$s See more here %2$s', 'evision-corporate' ), 'fa-user','<a href="'.esc_url('http://fontawesome.io/cheatsheet/').'" target="_blank">','</a>' ),
            )
        ),
