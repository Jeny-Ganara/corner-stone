...
$evision_corporate_settings_controls['evision-corporate-contact-cf7'] =
    array(
        'control' => array(
            'label'                 =>  __( 'Enter Contact Form Shortcode', 'evision-corporate' ),
            'section'               => 'evision-corporate-contact',
            'type'                  => 'text_html',
            'priority'              => 12,
            'description'       => sprintf( __( 'Recommended %1$s Contact Form 7 %2$s plugin', 'evision-corporate' ), '<a href="'.esc_url('https://wordpress.org/plugins/contact-form-7/').'" target="_blank">','</a>' ),
        )
    );
$evision_corporate_settings_controls['evision-corporate-contact-background'] =
    array(
