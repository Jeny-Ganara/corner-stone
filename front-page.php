...
if ( 'posts' == get_option( 'show_on_front' ) )
{
    ...
    else
    {
		...
		if( isset($evision_corporate_customizer_all_values['evision-corporate-enable-static-page']) && 0 == $evision_corporate_customizer_all_values['evision-corporate-enable-static-page']  ){
